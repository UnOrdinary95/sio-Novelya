...
export const updateUserCartById = async (
    req: Request,
    res: Response
): Promise<void> => {
    const currentUser = getAuthUser(req);
    ...
    try {
        ...
        res.status(500).json({
            error: "Erreur lors de la mise à jour du panier de l'utilisateur",
        });
    }
};

export const updateUserPurchaseHistoryById = async (
    req: Request,
    res: Response
): Promise<void> => {
    const currentUser = getAuthUser(req);
    ...
    try {
        ...
        res.status(500).json({
            error: "Erreur lors de la mise à jour de l'historique d'achats de l'utilisateur",
        });
    }
};

export const updatedWishlistById = async (
    req: Request,
    res: Response
): Promise<void> => {
    const currentUser = getAuthUser(req);
    ...
    try {
        ...
        res.status(500).json({
            error: "Erreur lors de la mise à jour de la wishlist de l'utilisateur",
        });
    }
};
